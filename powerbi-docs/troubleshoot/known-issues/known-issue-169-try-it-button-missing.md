...
In the past, you were able to try Power BI REST APIs on each operation referenced in the [REST API reference](/rest/api/power-bi).   Under **Examples**, you would see **Sample Request** code sections with a "Try it" button on the header to test the API.
